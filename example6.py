...
if __name__ == "__main__":
    ...
    emission_scenarios = [ 
        ...
        #EmissionScenario_HayliGubbi(h2o_e,"./scenarios/Hayli Gubbi_Ukhov_2025/so2_emisisons.txt")
        ]
    ...
    #cleaning the Ash SO2 scenarios by removing emissions below certain heights and times
    emission_scenarios[0].set_values_by_criteria(0, height_min_m=0, height_max_m=5000)
    
    #SO2
    emission_scenarios[1].set_values_by_criteria(0, height_min_m=0, height_max_m=5000)
    emission_scenarios[1].set_values_by_criteria(0, time_start='2025-11-24T08:00')#, time_end='2025-11-24T12:00') 
    #emission_scenarios[1].scale_values_by_criteria(0.6,time_start="2025-11-23 08:30",time_end="2025-11-23 18:00",height_min_m=10000,height_max_m=15000)    
    #emission_scenarios[1].scale_values_by_criteria(0.6,time_start="2025-11-24 02:00",time_end="2025-11-24 09:00",height_min_m=11000,height_max_m=14000)

    #cleaning the Water Vapor scenarios by removing emissions below certain heights and times
    #emission_scenarios[2].set_values_by_criteria(0, height_min_m=0, height_max_m=7500)
    #emission_scenarios[2].set_values_by_criteria(0, time_start='2025-11-24T08:00')#, time_end='2025-11-24T12:00') 
    ...
    emission_scenarios[0].save_fig("ash_hayli_gubbi.png", dpi=300)
    emission_scenarios[1].save_fig("so2_hayli_gubbi.png", dpi=300)
    emission_scenarios[2].save_fig("h2o_hayli_gubbi.png", dpi=300)
